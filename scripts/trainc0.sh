...
t_feat_type=clip 
results_root=results_crop_random_10_30_70
device=1
enc_layers=3
dec_layers=3
query_num=10
...
--num_queries 10 \
--exp_id base_notext_tgt_cc_${seed}_crop_random1 \
...
--neg_choose_epoch ${neg_choose_epoch} \
--num_queries 10 \
--exp_id base_notext_tgt_cc_${seed}_crop_random2 \
--m_classes "[10, 30, 70, 150]" \
--no_text \
--tgt_embed \
--cc_matching \
...
--neg_choose_epoch ${neg_choose_epoch} \
--num_queries 10 \
--exp_id base_notext_tgt_cc_${seed}_crop_random3 \
--m_classes "[10, 30, 70, 150]" \
--no_text \
--tgt_embed \
--cc_matching \
...
--neg_choose_epoch ${neg_choose_epoch} \
--num_queries 10 \
--exp_id base_notext_tgt_cc_${seed}_crop_random4 \
--m_classes "[10, 30, 70, 150]" \
--no_text \
--tgt_embed \
--cc_matching \
