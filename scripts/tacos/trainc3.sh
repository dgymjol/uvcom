...
--num_queries 10 \
--seed ${seed} \
--exp_id lad_both_mcls_3_crop_30_merge_30_${seed} \
...
--num_queries 10 \
--seed ${seed} \
--exp_id lad_both_mcls_3_crop_10_merge_10_${seed} \
--m_classes "[10.25, 19.34, 38.34, 10000000]" \
--cc_matching \
--tgt_embed \
--crop \
...
--num_queries 10 \
--seed ${seed} \
--exp_id notext_lad_both_mcls_3_crop_30_merge_30_${seed} \
--m_classes "[10.25, 19.34, 38.34, 10000000]" \
--cc_matching \
--tgt_embed \
--crop \
...
--num_queries 10 \
--seed ${seed} \
--exp_id notext_lad_both_mcls_3_crop_10_merge_10_${seed} \
--m_classes "[10.25, 19.34, 38.34, 10000000]" \
--cc_matching \
--tgt_embed \
--crop \
