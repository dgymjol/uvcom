...
# t_feat_type=clip 
# results_root=results_tacos/base
# device=1
# enc_layers=3
# dec_layers=3
# query_num=30
...
# lr_drop=100
# max_v=-1
# resume=results_tacos/base/tacos-video_tef-base_2025/model_best.ckpt
...
# CUDA_VISIBLE_DEVICES=${gpunum} PYTHONPATH=$PYTHONPATH:. python uvcom/eval.py \
# --dset_name ${dset_name} \
# --ctx_mode ${ctx_mode} \
