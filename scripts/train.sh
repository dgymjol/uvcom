...
--neg_choose_epoch ${neg_choose_epoch} \
--num_queries 10 \
--exp_id base_notext_tgt_cc_${seed} \
--m_classes "[10, 30, 70, 150]" \
--no_text \
--tgt_embed \
--cc_matching \
