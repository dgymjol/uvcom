...
t_feat_type=clip 
results_root=results_crop_base
device=1
enc_layers=3
dec_layers=3
query_num=10
...
--num_queries 30 \
--exp_id base_${seed}_crop_random4 \
--seed ${seed} \
--crop \
--fore_min 10 \
--back_min 10 \
...
# --neg_choose_epoch ${neg_choose_epoch} \
# --num_queries 30 \
# --exp_id base_${seed}_crop_random1 \
# --seed ${seed} \
# --crop \
# --fore_min 10 \
# --back_min 10 \
...
--neg_choose_epoch ${neg_choose_epoch} \
--num_queries 30 \
--exp_id base_${seed}_crop_random2 \
--seed ${seed} \
--crop \
--fore_min 15 \
--back_min 15 \
...
--neg_choose_epoch ${neg_choose_epoch} \
--num_queries 30 \
--exp_id base_${seed}_crop_random3 \
--seed ${seed} \
--crop \
--fore_min 15 \
--back_min 15 \
